...
public class ControladorMDI implements ActionListener{
    ...
    public ControladorMDI() {
        ...
        this.frmI.getMnuConsultaBD().addActionListener(this);
        this.frmI.getBtnConsultaBD().addActionListener(this);
    }
    ...
    public void actionPerformed(ActionEvent e) {        
        ...
        if(e.getSource().equals(frmI.getBtnConsultaBD()) || e.getSource().equals(frmI.getMnuConsultaBD()))
        {
            JIFrmConsultaBD frmC = new JIFrmConsultaBD();
            frmI.getEscritorio().add(frmC);
            frmC.setVisible(true);
            ControladorJIConsultaBD controlJIC_BD = new ControladorJIConsultaBD(frmC, objR);
            controlJIC_BD.iniciar();
        }
